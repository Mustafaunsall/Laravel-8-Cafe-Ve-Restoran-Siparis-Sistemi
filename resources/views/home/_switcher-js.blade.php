...
<div class="b-settings-panel">
    ...
    <div class="settings-section color-list">
        <div data-src="{{asset('assets')}}/restaurant/css/themes/blue.css" style="background: #45b5f5"></div>
        <div data-src="{{asset('assets')}}/restaurant/css/themes/brown.css" style="background: #dc8068"></div>
        <div data-src="{{asset('assets')}}/restaurant/css/themes/cyan.css" style="background: #00becc"></div>
        <div data-src="{{asset('assets')}}/restaurant/css/themes/green.css" style="background: #5bb75b"></div>
        <div data-src="{{asset('assets')}}/restaurant/css/themes/orange.css" style="background: #ff7149"></div>
        <div data-src="{{asset('assets')}}/restaurant/css/themes/pink.css" style="background: #fba1a1"></div>
        <div data-src="{{asset('assets')}}/restaurant/css/themes/red.css" style="background: #dc3522"></div>
        <div data-src="{{asset('assets')}}/restaurant/css/themes/yellow.css" style="background: #fdb813"></div>
    </div>
