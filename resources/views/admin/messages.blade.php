                                            ...
                                            <table id="datatable" class="table table-striped table-bordered"
                                                ...
                                                @foreach($datalist as $rs)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="{{route('admin_message_edit',['id'=>$rs->id])}}" onclick="return !window.open(this.href,'targetWindow','top=50 left=100 with=500,height=500')"><img style="height: 20px; width: 20px" src="{{ asset('assets/admin/images') }}/edit.png"></a> </td>
                                                        <td><a href="{{route('admin_message_delete',['id'=>$rs->id])}}"
                                                               onclick="return confirm('delete are you sure')"><img
                                                                    style="height: 20px; width: 20px"
                                                                    src="{{ asset('assets/admin/images') }}/sil.png"></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
